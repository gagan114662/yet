...
class RDAgentStrategy(QCAlgorithm):
    def Initialize(self):
        ...
        # Risk management
        self.SetRiskManagement(MaximumDrawdownPercentPerSecurity(0.029))
