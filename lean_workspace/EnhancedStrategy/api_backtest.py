...
def api_request(endpoint, method="GET", data=None):
    ...
    if method == "GET":
        response = requests.get(url, params={"userId": user_id, "token": api_token})
    elif method == "POST":
        response = requests.post(url, headers=headers, params={"userId": user_id, "token": api_token}, json=data)
