...
class HyperActiveStrategy(QCAlgorithm):
    """
    HIGH-FREQUENCY HYPERACTIVE STRATEGY
    ...
    def initialize(self):
        ...
        self.sma_slow = self.sma('QQQ', 10)
        self.rsi = self.rsi('QQQ', 6)
        self.atr = self.atr('QQQ', 10)
        
        # AGGRESSIVE PARAMETERS for high frequency
        self.stop_loss = 0.014
        self.take_profit = 0.07
        self.position_size = 3.2
    ...
    def on_data(self, data):
        ...
        if momentum_strong and rsi_favorable and not self.portfolio.invested and not_recently_traded:
            ...
            self.log(f"ENTRY #{self.trade_count}: ${current_price:.2f} - HyperActive")
    ...
    def on_end_of_algorithm(self):
        ...
        if years > 0:
            ...
            self.log(f"FINAL RESULTS - HyperActive:")
