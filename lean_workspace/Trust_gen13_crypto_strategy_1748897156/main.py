...
class TrustworthyStrategy(QCAlgorithm):
    """
    Trustworthy Strategy - Agent: gen13_crypto_strategy
    Config: BITO 15.0x leverage, 2.0x position, SMA(5,15)
    """
    ...
    def initialize(self):
        ...
        self.sma_slow = self.sma("BITO", 15)
