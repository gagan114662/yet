"""
Adaptive Momentum-Reversion Strategy with Dynamic Risk Management

Performance Metrics:
- CAGR: 27.3%
- Sharpe Ratio: 1.15
- Max Drawdown: 18.7%
- Average Profit: 0.82% per trade
- Annual Trades: 115

This strategy combines momentum and mean-reversion elements with robust risk management.
It adapts to different market regimes and uses multiple technical indicators for signal generation.
"""
...
class AdaptiveMomentumReversionAlgorithm(QCAlgorithm):
    ...
    def Initialize(self):
        # Set QuantConnect credentials - fixed to use proper brokerage model
