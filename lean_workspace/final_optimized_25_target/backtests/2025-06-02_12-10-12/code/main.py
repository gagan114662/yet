...
class FinalOptimized25Target(QCAlgorithm):
    ...
    def CalculateOptimalPosition(self, current_price):
        ...
        # Moving average momentum (simplified)
        sma20_momentum = (current_price - self.sma_20.Current.Value) / self.sma_20.Current.Value
        sma50_momentum = (current_price - self.sma_50.Current.Value) / self.sma_50.Current.Value
        ...
        if above_200sma and above_50sma and above_20sma:
            ...
            if sma20_momentum > 0.02 and sma50_momentum > 0.01:  # Strong momentum
                base_position = 2.5  # 250% with 3x leverage = 7.5x exposure
            elif sma20_momentum > 0.01:  # Moderate momentum
