...
class VandanStrategyBurke(QCAlgorithm):
    ...
    def Initialize(self) -> None:
        ...
        option.SetFilter(lambda u: u.Strikes(-30, 30)   # Wider range for OTM puts
    ...
    def strategy_params(self) -> None:
        ...
        self.sell_leg_atr_multiplier = 2.5 # Multiplier for ATR distance
        self.buy_leg_insurance_atr_multiplier = 3.5  # Multiplier for insurance leg distance
        self.minimum_premium = 0.25
        self.conditional_exit_price = 0.80  # Price to trigger exit order
