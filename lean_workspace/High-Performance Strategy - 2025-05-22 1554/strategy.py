...
class HighPerformanceStrategy(QCAlgorithm):
    ...
    def Initialize(self):
        # Set start and end dates for backtest - use a longer period for better validation
        self.SetStartDate(2010, 1, 1)  # 15 years of data for comprehensive validation
        ...
        # Include more volatile assets to increase potential returns
        self.symbols = ["SPY", "QQQ", "IWM", "EEM", "GLD", "TLT", "USO", "UNG", "XLF", "XLE", 
                       "TQQQ", "SQQQ", "UPRO", "SPXU", "FAS", "FAZ", "LABU", "LABD"]
        self.data = {}
        
        # Add symbols and indicators
        for symbol in self.symbols:
            security = self.AddEquity(symbol, Resolution.Daily)
            security.SetLeverage(3)  # Use higher leverage to boost returns
        ...
        # Strategy parameters - more aggressive to meet performance targets
        self.rebalance_days = 1  # Rebalance daily to increase trade frequency
        self.max_positions = 6  # Maximum number of positions at any time
