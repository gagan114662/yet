...
class RapidFireStrategy(QCAlgorithm):
    """
    HIGH-FREQUENCY RAPIDFIRE STRATEGY
    ...
    def on_data(self, data):
        ...
        if momentum_strong and rsi_favorable and not self.portfolio.invested and not_recently_traded:
            ...
            self.log(f"ENTRY #{self.trade_count}: ${current_price:.2f} - RapidFire")
    ...
    def on_end_of_algorithm(self):
        ...
        if years > 0:
            ...
            self.log(f"FINAL RESULTS - RapidFire:")
